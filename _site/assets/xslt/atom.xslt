...
<xsl:template match="/atom:feed">
	...
	<meta property="og:description" content="Jun Allard - Mathematical Biology, Biophysics Cell and Molecular Mechanics @ University of California Irvine">
	<meta property="og:url" content="http://localhost:4000/assets/xslt/atom.xslt">
	<meta property="og:locale" content="en_EN">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Allard Lab">
	...
	<meta name="twitter:site" content="allardlab">
	<meta name="twitter:creator" content="allardlab">
	<meta name="twitter:title" content="Atom Feed (Styled)">
	<meta name="twitter:description" content="Jun Allard - Mathematical Biology, Biophysics Cell and Molecular Mechanics @ University of California Irvine">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/" > ALLARD LAB </a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 small-centered columns">
			<div style="display:table;width:100%;height:175px;">
				<div style="display:table-cell;width:100%;vertical-align:middle;">
					<div style="text-align:center;">
						<a href="http://localhost:4000/" title="Allard Lab">
							<!--<img src="http://localhost:4000/assets/img/frontpage_title.png" alt="Allard Lab">-->
							<span style="font-size: 22.5pt; font-weight: bold; color: black; font-family:supria-sans">ALLARD LAB @ UC IRVINE</span><br>
      ...
      <div id="subfooter">
        <nav class="row">
          ...
          <section id="subfooter-left" class="small-12 columns credits">
            <p>Created with <a href="http://jekyllrb.com/" target="_blank">Jekyll</a> based on the <a href="http://phlow.github.io/feeling-responsive/">Feeling Responsive</a> theme</p>
          </section>
